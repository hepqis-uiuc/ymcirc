...
if __name__ == "__main__":
    ...
    script_options = configure_script_options(
        ...
        method='matrix_product_state',  # matrix_product_state, statevector, etc. See Qiskit Aer docs. (2026/03/17): as of current date, AerSimulator has a hard cap of 63 qubits for MPS simulations. functions.py includes workaround hack for MPS simulations.
