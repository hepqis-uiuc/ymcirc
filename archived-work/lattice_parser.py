...
Currently a work in progress. Currently incompatible with the rest of the package
because of changes in how vertex singlet data are handled.
"""
import json
import pickle
...
class ParsedData:
    ...
    def __init__(self,
        ...
        """
        raise NotImplementedError("This class is no longer compatible with the rest of ymcirc. Requires update. Do not use.")
        # self.dim = dim
