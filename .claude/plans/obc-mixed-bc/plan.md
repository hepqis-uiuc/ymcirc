...
- [ ] **1.1 Design universal lattice cases in `gen_ymcirc_data.py`**
...
- [ ] **1.3 Run data generation for T-truncation universal files**
...
- [ ] **2.1 Accept tuple-valued `periodic_boundary_conds`**
...
- [ ] **2.2 Implement `add_unit_vector_to_vertex_vector()` for non-periodic lattices**
...
- [ ] **2.3 Implement `_normalize_link_address()` for non-periodic lattices**
...
- [ ] **2.4 Implement `get_traversal_order()` for non-periodic lattices**
...
- [ ] **2.5 Make `n_plaquettes` boundary-aware**
...
- [ ] **2.6 Handle `n_control_links_per_plaquette` for non-periodic lattices**
...
- [ ] **2.7 Implement `get_vertex()` without modular wrapping in `lattice_registers.py`**
