...
parsed_data = quant_run.parser(reverse=False,print_to_file=False)
quant_run.lattice_images(parsed_data)
#print(quant_run.parser()['110111001101'])
#quant_run.lattice_images(parsed_filepath="n_trotter=1-t=0.1_H1-1E.json-parsed",generate_pdf=True)
#quant_run.lattice_visualizer("010110001000",image_filepath="n_trotter=1-t=0.1_H1-1E.json-images")
